...
eye_tracker=True #If set  to True will display output of eye tracker on screen. 
                #If False eyetracker will run in background without any graphical display 

#Cloud Configuration Variables( IBM db2)
driver="Deloitte" #Username of driver(Driver_ID) in cloud Database
    ...
    def restart(self):
        ...
        # Set up the sensors.
            if preview:
                ...
                cam_bp.set_attribute("image_size_x",f"{w}")
